...
let(:invalid_params)do {
  ...
  describe "GET /new" do
    ...
    it "renders a successful response" do
      get edit_department_member_url(department_member)
      expect(response).to be_successful
    end
  end
   ...
   let(:department_member){create(:department_member)}
    ...
    it "updates a member" do
      patch department_member_url(department_member), params: valid_params
      expect(response).to redirect_to department_members_url
    end
     it "doesn't update a member" do
      patch department_member_url(department_member), params: invalid_params
      expect(response).not_to redirect_to department_members_url
    end
  end
  ...
  describe "POST /department_members" do
    ...
    it "creates a new department member" do
      post department_members_url, params: valid_params 
    ...
    it "doesn't create a new department member" do
      post department_members_url, params: invalid_params
      expect(response).not_to redirect_to department_members_url 
    end
  end
  ...
  describe "DELETE /destroy" do
   let(:department_member){create(:department_member)}
    ...
    it "deletes a group member" do
      delete department_member_url(department_member)
      expect(response).to redirect_to department_members_url
    end
  end
